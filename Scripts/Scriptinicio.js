document.addEventListener('DOMContentLoaded', function() {
    ...
    const iconoPasswordLogin = document.getElementById('icono-password-login');
    const modo = localStorage.getItem('modo') || 'claro';
    if (iconoPasswordLogin) {
        iconoPasswordLogin.src = modo === 'oscuro' ? 'Assets/ocultaroscuro.png' : 'Assets/ocultarclaro.png';
    }
            ...
            if (answer.toLowerCase() === correctAnswer.toLowerCase()) {
                ...
                content.innerHTML = `
                    ...
                    <div class="password-container">
                        ...
                        <button id="toggle-new-password" class="toggle-password-btn">
                            <img id="icono-new-password" src="Assets/ocultaroscuro.png" alt="Mostrar/Ocultar contraseña" class="icono-password" />
                        </button>
                    </div>
                    <div class="password-container">
                        <input type="password" id="confirm-password" placeholder="Confirmar contraseña" required>
                        <button id="toggle-confirm-password" class="toggle-password-btn">
                            <img id="icono-confirm-password" src="Assets/ocultaroscuro.png" alt="Mostrar/Ocultar contraseña" class="icono-password" />
                        </button>
                    </div>
                    ...
                    <p id="mensaje-error"></p>
                `;
                // Agregar toggles para contraseñas
                setTimeout(() => {
                    const toggleNew = document.getElementById('toggle-new-password');
                    const toggleConfirm = document.getElementById('toggle-confirm-password');
                    const newPassInput = document.getElementById('new-password');
                    const confirmPassInput = document.getElementById('confirm-password');
                    const iconoNew = document.getElementById('icono-new-password');
                    const iconoConfirm = document.getElementById('icono-confirm-password');
                    const modo = localStorage.getItem('modo') || 'claro';
                    if (iconoNew) iconoNew.src = modo === 'oscuro' ? 'Assets/ocultaroscuro.png' : 'Assets/ocultarclaro.png';
                    if (iconoConfirm) iconoConfirm.src = modo === 'oscuro' ? 'Assets/ocultaroscuro.png' : 'Assets/ocultarclaro.png';
