document.addEventListener('DOMContentLoaded', function () {
    ...
    const toggleConfirmPass = document.getElementById('toggle-confirm-pass');
    const newPassInput = document.getElementById('new-pass');
    const confirmPassInput = document.getElementById('confirm-pass');
    const iconoNewPass = document.getElementById('icono-new-pass');
    const iconoConfirmPass = document.getElementById('icono-confirm-pass');
    const modo = localStorage.getItem('modo') || 'claro';
    if (iconoNewPass) iconoNewPass.src = modo === 'oscuro' ? 'Assets/ocultaroscuro.png' : 'Assets/ocultarclaro.png';
    if (iconoConfirmPass) iconoConfirmPass.src = modo === 'oscuro' ? 'Assets/ocultaroscuro.png' : 'Assets/ocultarclaro.png';
    ...
    if (toggleConfirmPass) {
        toggleConfirmPass.addEventListener('click', function(e) {
            e.preventDefault();
